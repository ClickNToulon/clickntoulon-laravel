                ...
                <tbody>
                    <tr v-for="user in users.data" class="border-b border-gray-300 last-of-type:border-none overflow-x-auto" :key="user.id">
                        ...
                        <td class="py-4 space-y-2 lg:space-y-0 lg:space-x-2 flex flex-col lg:flex-row">
                            ...
                            <button type="button" @click="openModal" class="font-bold text-danger px-4 py-1.5 border-2 border-transparent rounded-xl focus-visible:ring-offset-0">
                                Ban
                            </button>
                                            ...
                                            >
                                                <DialogPanel class="w-full max-w-sm transform overflow-hidden rounded-2xl bg-white p-2 text-left align-middle transition-all">
                                                    <div class="p-4 pb-0 w-full">
                                                        ...
                                                        <DialogTitle as="h3" class="text-xl font-bold leading-6 text-gray-900 text-center mt-2">
                                                            Ban User
                                                        </DialogTitle>
                                                        <div class="mt-4">
                                                    ...
                                                    <div class="mt-4 flex flex-col items-center justify-end">
                                                        <button
                                                            ...
                                                            class="font-bold w-full text-slate-900 text-center px-4
                                                            py-1.5 border-2 border-transparent rounded-xl"
                                                        >
                                                            Cancel
                                                        </button>
                                                        <button
                                                            ...
                                                            class="font-bold text-white px-4 py-1.5 border-2 uppercase
                                                            transition duration-300 rounded-xl justify-center flex
                                                            items-center w-full hover:bg-red-700 hover:border-red-700">
                            ...
                            <TransitionRoot appear :show="isSuccessOpen" as="template">
                                                ...
                                                <DialogPanel class="w-full max-w-sm transform overflow-hidden rounded-2xl bg-white p-2 text-left align-middle transition-all">
                                                    ...
                                                    <div class="mt-4 flex flex-col items-center justify-end">
                                                        <button
                                                            ...
                                                            title="Close Modal"
                                                            class="font-bold text-white px-4 py-1.5 border-2
                                                            border-success bg-success transition duration-300 rounded-xl
                                                            justify-center flex items-center w-full hover:bg-green-800 hover:border-green-800 uppercase">
                                                            Close
                                                        </button>
                                                    </div>
                                                </DialogPanel>
