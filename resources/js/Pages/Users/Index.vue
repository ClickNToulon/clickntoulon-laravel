            ...
            <table class="w-full text-sm text-left text-slate-900 table-fixed z-10 overflow-x-auto">
                ...
                <tbody>
                    <tr v-for="user in users.data" class="border-b border-gray-300 last-of-type:border-none overflow-x-auto" :key="user.id">
                        ...
                        <td class="py-4">
                            <span v-if="user.isBanned" class="text-white font-semibold px-3 py-1 rounded-xl bg-danger">Banned</span>
                            <span v-else class="text-white font-semibold px-3 py-1 rounded-xl bg-success">Active</span>
                        </td>
                        <td class="py-4 space-y-2 lg:space-y-0 lg:space-x-2 flex flex-col lg:flex-row">
                            ...
                            <button type="button" v-if="!user.ban" @click="openModal(user, user.isBanned)" class="font-bold text-danger px-4 py-1.5 border-2 border-transparent rounded-xl focus-visible:ring-offset-0">
                                Ban
                            </button>
                            <button type="button" v-else @click="openModal(user, user.isBanned)" class="font-bold text-success px-4 py-1.5 border-2 border-transparent rounded-xl focus-visible:ring-offset-0">
                                Unban
                            </button>
                                            ...
                                            >
                                                <DialogPanel class="w-full max-w-sm transform overflow-hidden rounded-2xl bg-white p-2 text-left align-middle transition-all">
                                                    <div class="p-4 pb-0 w-full">
                                                        ...
                                                        <DialogTitle as="h3" class="text-xl font-medium leading-6 text-gray-900 text-center mt-2" v-if="!id.isBanned">
                                                            User banned successfully
                                                        </DialogTitle>
                                                        <DialogTitle as="h3" class="text-xl font-medium leading-6 text-gray-900 text-center mt-2" v-else>
                                                    ...
                                                    <div class="mt-4 flex flex-col items-center justify-end">
                                                        <button
                                                            ...
                                                            title="Close Modal"
                                                            class="font-semibold text-white px-4 py-1.5 border-2 border-success bg-success transition duration-300 rounded-xl justify-center flex items-center w-full hover:bg-green-800 hover:border-green-800 uppercase">
                                                            Close
                                                        </button>
                                                    </div>
                                                </DialogPanel>
                    ...
                    >
                        <DialogPanel class="w-full max-w-sm transform overflow-hidden rounded-2xl bg-white p-2 text-left align-middle transition-all">
                            <div class="p-4 pb-0 w-full">
                                ...
                                <DialogTitle as="h3" class="text-xl font-semibold leading-6 text-gray-900 text-center mt-2" v-if="!ban">
                                    Ban User
                                </DialogTitle>
                                <DialogTitle as="h3" class="text-xl leading-6 text-gray-900 text-center mt-2" v-else>
                                    Unban User
                                </DialogTitle>
                            ...
                            <div class="mt-4 flex flex-col items-center justify-end">
                                <button
                                    ...
                                    class="font-semibold w-full text-slate-900 text-center px-4 py-1.5 border-2 border-transparent rounded-xl"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    class="font-semibold text-white px-4 py-1.5 border-2 uppercase transition duration-300 rounded-xl justify-center flex items-center w-full hover:bg-red-700 hover:border-red-700">
                                ...
                                <button
                                    ...
                                    class="font-semibold text-white px-4 py-1.5 border-2 uppercase transition duration-300 rounded-xl justify-center flex items-center w-full hover:bg-green-700 hover:border-green-700">
