...
<template>
    <GuestLayout>
        <div class="w-full sm:max-w-[450px] mt-6 px-6 py-4 overflow-hidden">
            <Head title="Log in" />
            ...
            <form @submit.prevent="submit">
                ...
                <div class="block mt-4">
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-slate-700 font-medium">Remember me</span>
                    </label>
                </div>

                <div class="flex items-center justify-end mt-4">
                    <Link v-if="canResetPassword" :href="route('password.request')" class="underline text-sm text-gray-700 font-medium hover:text-gray-900">
    ...
    <!--<div class="flex items-center min-h-screen bg-gray-50">
        <div class="flex-1 h-screen mx-auto bg-white rounded-lg shadow-xl">
            <div class="flex flex-col md:flex-row h-full ">
                <div class="h-32 md:h-auto md:w-1/2">
                    <img class="object-cover w-full h-full" src="https://source.unsplash.com/user/erondu/1600x900"
                         alt="img" />
                </div>
                <div class="flex items-center justify-center mx-auto p-6 sm:p-12 md:w-1/2">
